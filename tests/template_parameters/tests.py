...
test_connector = flights_connector
...
class ParserTests(unittest.TestCase):
    ...
    def test_bad_parameter_name(self):
        ...
        self.assertRaises(ParameterParseException, TemplateParameter, param_str=param_string, param_type='dependent', db_connector=test_connector)

    def test_container_type(self):
        """ Test container type parsing. """
        param_string = "test_param|value_list:str"
        template_parameter = TemplateParameter(param_str=param_string, param_type='dependent', db_connector=test_connector)
...
class QueryValueTests(unittest.TestCase):
    ...
    def test_string_value(self):
        ...
        independent_parameter = TemplateParameter(param_str=test_param_str, param_type='independent', db_connector=test_connector)
