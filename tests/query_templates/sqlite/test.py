...
from querygraph.query.templates import sqlite
...
class ParameterTests(unittest.TestCase):
    ...
    def test_datetime(self):
        ...
        test_param = sqlite.SqliteParameter(parameter_type='independent', parameter_str=param_str)
...
class TemplateTests(unittest.TestCase):
    ...
    def test_simple_query(self):
        ...
        query_template = sqlite.QueryTemplate(template_str=query,
