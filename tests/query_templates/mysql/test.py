...
from querygraph.query.templates import mysql
...
class ParameterTests(unittest.TestCase):
    ...
    def test_datetime(self):
        ...
        test_param = mysql.MySqlParameter(parameter_type='independent', parameter_str=param_str)
...
class TemplateTests(unittest.TestCase):
    ...
    def test_simple_query(self):
        ...
        query_template = mysql.QueryTemplate(template_str=query,
